...
export class VolumeProfile {
  ...
  public getSession(
    ...
    for (const price of prices) {
      const change = this.percentageDifference(price, middlePrice);
  ...
  nextValue(candle: Candle) {
    ...
    this.addToSession(priceSource, candle.volume);
    this.sum += candle.volume;
   ...
   * Percent change
   */
  private percentageDifference(a: number, b: number): number {
